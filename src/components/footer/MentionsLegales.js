  ...
  return (
    <div className="mentionsLegales">
      ...
      <p>
        ...
        visiteurs, ci-après l""Utilisateur", du site http://www.jardimotors.fr ,
      ...
      <p>
        L’édition et la direction de la publication du Site est assurée par Sami
        BRAHIM dont l'adresse e-mail est sbrahimcode@gmail.com
      </p>
      <p>ci-après l'"Editeur".</p>
      <h4>ARTICLE 2 - L'HEBERGEUR</h4>
      <p>
        L'hébergeur du Site est la société IONOS, dont le siège social est situé
        au 7 Place de la gare -57200 SARREGUEMINES.
        {/* , avec le numéro de
        téléphone : _______________ + adresse mail de contact */}
      </p>
